 ...
 * @author 田鑫龙
 */
boot.DatePicker = function load(id) {
...
boot.extend(boot.DatePicker, boot.Rooter, {
    ...
    _createView : function() {
        ...
        html.push('<thead>');
        html.push('<tr>');
        html.push('<td style="border-bottom-style: solid;border-bottom-width: 1px;cursor: default;">日</td>');
        html.push('<td style="border-bottom-style: solid;border-bottom-width: 1px;cursor: default;">一</td>');
        html.push('<td style="border-bottom-style: solid;border-bottom-width: 1px;cursor: default;">二</td>');
        html.push('<td style="border-bottom-style: solid;border-bottom-width: 1px;cursor: default;">三</td>');
        html.push('<td style="border-bottom-style: solid;border-bottom-width: 1px;cursor: default;">四</td>');
        html.push('<td style="border-bottom-style: solid;border-bottom-width: 1px;cursor: default;">五</td>');
        html.push('<td style="border-bottom-style: solid;border-bottom-width: 1px;cursor: default;">六</td>');
        html.push('</tr>');
        html.push('</thead>');
        html.push('</table>');
    ...
    _getFebruaryDays : function() {
        return (this.years % 4 == 0 && this.years % 100 != 0) || (this.years % 400 == 0) ? 29 : 28;
    },
    ...
    _renderBox : function() {
        ...
        var html = new boot.HTML('<tr>');
        var cls = 'day prev-month-day';
        for (var i = fixed; i > 0; ) {
            html.push('<td class="' + cls + '">');
            html.push(prevMonthDays - --i);
            html.push('</td>');
        }
        if (fixed == 7) {
            html.push("</tr><tr>");
        ...
        for (var i = 1; i <= currentMonthDays; i++) {
            html.push('<td class="' + cls + this._markToday(i) + '">');
            html.push(i);
            html.push('</td>');
            if ((i + fixed) % 7 === 0) {
                if (rows == 6) {
